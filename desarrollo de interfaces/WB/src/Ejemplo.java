...
public class Ejemplo {
	...
	private void initialize() {
		...
		JRadioButton rdbtnNewRadioButton = new JRadioButton("Soy Un JRadioButton");
	...
	// Hemos creado un grupo para agregar los dos botones.
		ButtonGroup grupo1 = new ButtonGroup();
		grupo1.add(rdbtnNewRadioButton);
		grupo1.add(rdbtnSoyUnJradiobutton);
	}
}
